...
import {
  ...
  Building2, ExternalLink, ThumbsUp,
} from "lucide-react";
    ...
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 bg-primary/95 backdrop-blur-sm border-b border-white/10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between h-14">
          ...
          <button
            className="md:hidden text-primary-foreground/70 hover:text-primary-foreground p-1"
          ...
          <div className="max-w-md">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="bg-accent text-primary font-semibold px-6 py-3.5 rounded-sm flex items-center justify-center gap-2 hover:bg-accent/90 transition-colors text-sm"
              >
                <MapPin size={15} />
                Report an Issue
              </button>
              <button
                ...
                className="border border-white/20 text-primary-foreground px-6 py-3.5 rounded-sm flex items-center justify-center gap-2 hover:bg-white/8 transition-colors text-sm"
              >
                <BookOpen size={15} />
                Civic Literacy
              </button>
            ...
            <div className="lg:col-span-2 bg-card border border-border rounded-sm p-6 shadow-sm">
              ...
              {reportSubmitted ? (
                ...
                <form onSubmit={handleReport} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-accent text-primary font-semibold py-3 rounded-sm flex items-center justify-center gap-2 hover:bg-accent/90 transition-colors text-sm mt-1"
                  >
                    <MapPin size={15} />
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {visibleIssues.map((issue) => {
              ...
              return (
                <div
                  key={issue.id}
                  className="bg-card border border-border rounded-sm p-5 hover:shadow-md transition-all group"
                >
